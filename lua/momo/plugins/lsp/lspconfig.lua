...
-- import rust-analyzer plugin safely
local rust_analyzer_status, rust_analyzer = pcall(require, "rust_analyzer")
if not rust_analyzer_status then
	return
end

local keymap = vim.keymap -- for coniceness
